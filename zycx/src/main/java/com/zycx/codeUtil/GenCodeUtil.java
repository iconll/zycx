...
public class GenCodeUtil {
    ...
    public static void genFiles(String author, String tableName, String extendsBasePackage, String basePackage, String mybatisBasePath,  String beanName, String queryModelName, String properitesUri) throws IOException {
        ...
        if(fEntity.exists()){
            System.out.println("文件已存在，为防止误操作代码文件被覆盖，所以不能重新生成，要想重新生成请来该方法处理。");
            return;
            //fEntity.delete();//要想重新生成请注释return,放开delete注释。
        }
        ...
        if(StringUtils.isNotEmpty(queryModelName)){
            ...
            if(fQEntity.exists()){
                System.out.println("文件已存在，为防止误操作代码文件被覆盖，所以不能重新生成，要想重新生成请来该方法处理。");
                return;
                //fQEntity.delete();//要想重新生成请注释return,放开delete注释。
            }
    ...
    public static void main(String[] args) throws IOException {
        genFiles("gly", "jz_kyed_info", "com.zycx.system.common.base","com.zycx.system.sys", "/resources/mybatis/mapper","JzKyedInfo", "QueryJzKyedInfo", "application-dev.properties");
    }
